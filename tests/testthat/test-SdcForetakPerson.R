...
test_that("SdcForetakPerson works", {
  ...
  expect_identical(SF(z100, between = prikkeVarB, within = c("PERS_KJOENN", "alder6"), nace00="85", allowTotal = TRUE, til0 = FALSE),  40943387364) 
  expect_identical(SF(z100, between = prikkeVarB, within = c("PERS_KJOENN", "alder6"), nace00="85", allowTotal = TRUE, til0 = TRUE),  40944962502)
  expect_identical(SF(z100, between = prikkeVarB, within = c("PERS_KJOENN", "alder6"), allowTotal = FALSE), 40428997551) 
  expect_identical(SF(z100, between = prikkeVarB, within = c("PERS_KJOENN", "alder6"), allowTotal = TRUE, til0 = FALSE), 40194581165)
  expect_identical(SF(z100, between = prikkeVarB, within = c("PERS_KJOENN", "alder6"), allowTotal = TRUE, til0 = TRUE), 40198512037)
